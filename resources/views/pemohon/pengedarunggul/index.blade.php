                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody class="text-left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($d->status == 'Selesai')
                                        <a class="btn btn-sm btn-success text-white" target="_blank" href="{{ route('report.pengedarunggul', $d->id) }}">
                                            <i class="fas fa-print"></i>
                                          </a>
                                          @else
                                          <a class="btn btn-sm btn-info text-white" href="{{ route('user.pengedarunggul.edit', $d->id) }}">
                                            <i class="fas fa-edit"></i>
                                          </a>
                                        <button data-target="#modaldelete" data-toggle="modal" type="button"
                                            class="delete btn btn-sm bg-danger"
                                            data-link="{{ route('user.pengedarunggul.destroy',$d->id) }}">
