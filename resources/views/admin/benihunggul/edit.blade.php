        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{ route('admin.benihunggul.update', $benihunggul->id) }}">
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_akhir" name="tanggal_akhir" value="{{$benihunggul->tanggal_akhir}}"
                                            placeholder="Masukan Nomor Surat">
                                    </div>
                                    @elseif($benihunggul->status == "Selesai")
                                    <label>Kelas Benih</label>
                                    <select name="kelas_benih" class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option selected="selected" data-select2-id="3">--Pilih--
                                    </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_diterima" name="tanggal_diterima" value="{{$benihunggul->tanggal_diterima}}"
                                                placeholder="Masukan Nomor Surat">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="modal-footer justify-content-between">
                                <td>
                                    <a type="button" href="{{ route('admin.benihunggul.index') }}"
