                ...
                <div class="card">
                    <div class="card-header">
                        <td>
                            ...
                            <a type="button" href="{{ route('report.rekomendasiunggulfilter') }}" class="btn  btn-primary float-right" target="_blank">Cetak
                            </a>
                        </td>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody class="text-left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <a class="btn btn-sm btn-info text-white" href="{{ route('admin.benihunggul.edit', $d->id) }}">
