                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="tanggal_akhir" name="tanggal_akhir" value="{{$pengedarlokal->tanggal_akhir}}"
                                                    placeholder="Masukan Nomor Surat">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_diterima" name="tanggal_diterima" value="{{$pengedarlokal->tanggal_diterima}}"
                                                placeholder="Masukan Nomor Surat">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-check-input" name="sarana[]" value="Jumlah Tenaga Kerja Lebih Dari 2 Orang" {{ in_array('Jumlah Tenaga Kerja Lebih Dari 2 Orang', $pengedarlokal->sarana) ? 'checked' : '' }} type="checkbox">
                                            <label class="form-check-label">Jumlah Tenaga Kerja Lebih Dari 2 Orang</label>
                                            </div>
                                            <div class="form-check">
                                            <input class="form-check-input" name="sarana[]" value="Adanya Alat Transportasi, Gudang/Tempat Penyimpanan Benih" {{ in_array('Adanya Alat Transportasi, Gudang/Tempat Penyimpanan Benih', $pengedarlokal->sarana) ? 'checked' : '' }} type="checkbox">
