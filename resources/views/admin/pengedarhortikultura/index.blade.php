                ...
                <div class="card">
                    <div class="card-header">
                        <td>
                            ...
                            <a type="button" href="{{ route('report.pengedarhortikulturafilter') }}" class="btn  btn-primary float-right" target="_blank">Cetak
                            </a>
                        </td>
                    </div>
                    <!-- /.card-header -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-success text-white" target="_blank" href="{{ route('report.pengedarhortikultura', $d->id) }}">
                                          ...
                                          @endif
                                        <a class="btn btn-sm btn-info text-white" href="{{ route('admin.pengedarhortikultura.edit', $d->id) }}">
                                            <i class="fas fa-edit"></i>
                                          </a>
                                        <button data-target="#modaldelete" data-toggle="modal" type="button"
                                            class="delete btn btn-sm bg-danger"
                                            data-link="{{ route('admin.pengedarhortikultura.destroy',$d->id) }}">
