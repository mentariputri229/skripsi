...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h3 style="text-align:center; text-decoration: underline;">REKOMENDASI SEBAGAI PENGEDAR BENIH VARIETAS LOKAL</h3>
        ...
        <br>
        <p style="text-align: justify;">Dinyatakan layak dan diberikan rekomendasi sebagai pengedar benih Varietas Lokal, Penetapan Rekomendasi Sebagai Pengedar Benih Tanaman Pangan Berlaku selama yang bersangkutan masih aktif mengedarkan/memperdagangkan benih Varietas Lokal tanaman pangan dan bersedia dilakukan peninjauan ulang minimal 1(satu) kali dalam setahun.</p>
