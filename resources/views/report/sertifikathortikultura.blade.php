...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h3 style="text-align:center; text-decoration: underline;">REKOMENDASI SEBAGAI PRODUSEN BENIH HORTIKULTURA</h3>
        ...
        <table >
            <tr >
                ...
                <td width= "15px">:</td>
                <td style="text-align: justify;">Dinyatakan layak dan diberikan rekomendasi sebagai produsen benih Hortikultura</td>
            </tr>
            <tr >
                <td width="10px" style="height:20px">2</td>
                <td width= "15px">:</td>
                <td style="text-align: justify;">Rekomendasi sebagai produsen benih Hortikultura berlaku selama masih memproduksi Hortikultura</td>
            </tr>
            <tr >
                <td width="10px" style="height:20px">3</td>
                <td width= "15px">:</td>
                <td style="text-align: justify;">Pemeriksaan ulang atas rekomendasi sebagai produsen benih Hortikultura dilakukan minimal 1 (satu) kali dalam setahun</td>
            </tr>
    </table>
            <br>
