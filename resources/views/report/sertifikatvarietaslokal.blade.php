...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h3 style="text-align:center; text-decoration: underline;">REKOMENDASI SEBAGAI PRODUSEN BENIH VARIETAS LOKAL</h3>
            ...
            <table >
                ...
                <tr >
                    <td width="180px" style="height:20px">Kelas Benih</td>
                    <td width= "15px">:</td>
                    <td text-align="left">{{ $data->kelas_benih }}</td>
                </tr>
        </table>
        <br>
        <table >
            <tr >
                <td width="10px" style="height:20px">1</td>
                <td width= "15px">:</td>
                <td style="text-align: justify;">Dinyatakan layak dan diberikan rekomendasi sebagai produsen benih Varietas Lokal</td>
            </tr>
            <tr >
                <td width="10px" style="height:20px">2</td>
                <td width= "15px">:</td>
                <td style="text-align: justify;">Rekomendasi sebagai produsen benih Varietas Lokal berlaku selama masih memproduksi Varietas Lokal</td>
            </tr>
            <tr >
                <td width="10px" style="height:20px">3</td>
                <td width= "15px">:</td>
                <td style="text-align: justify;">Pemeriksaan ulang atas rekomendasi sebagai produsen benih Varietas Lokal dilakukan minimal 2 (satu) kali dalam setahun</td>
            </tr>
    </table>
