...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h3 style="text-align:center; text-decoration: underline;">REKOMENDASI SEBAGAI PRODUSEN BENIH UNGGUL</h3>
        ...
        <table >
            <tr >
                ...
                <td width= "15px">:</td>
                <td style="text-align: justify;">Dinyatakan layak dan diberikan rekomendasi sebagai produsen benih Unggul</td>
            </tr>
            <tr >
                <td width="10px" style="height:20px">2</td>
                <td width= "15px">:</td>
                <td style="text-align: justify;">Rekomendasi sebagai produsen benih Unggul berlaku selama masih memproduksi Unggul</td>
            </tr>
            <tr >
